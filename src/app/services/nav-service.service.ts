...
export class NavServiceService {
  ...
  navlink = [
    ...
    ['Zabawki', 'zabawki', [['Inteligentne zabawki', 'inteligentne-zabawki'], ['Zabawki dla szczeniąt', 'zabawki-dla-szczeniąt'], ['Piłki', 'pilki'], ['Frisbee i zabawki do rzucania', 'srodki-odstraszajace-pchly-i-kleszcze'], ['Pluszowe zabawki', 'pluszowe-zabawki'], ['Zabawki wodne', 'zabawki-wodne'],['Basen', 'basen']]],
  ]
